...
export const searchDefault: Story<SearchProps> = () => <Search sourceData={database} />
...
export const ValidationUrl: Story<SearchProps> = () => <Search sourceData={noUrl} searchOn='url' />
